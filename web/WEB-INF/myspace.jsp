    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">开设课程</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form class="card-body" action="addCourse" method="post" id="addcourse">
                    <div class="form-group">
                        <label>课程名称</label>
                        <input type="text" id="nameAdd" name="course_name" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>课程描述</label>
                        <input type="text" id="intrdAdd" name="introduction" class="form-control">
                    </div>
                    <div class="form-group">
                        <label>课程封面</label>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" form="addcourse">确认</button>
            </div>
        </div>
    </div>
</div>
